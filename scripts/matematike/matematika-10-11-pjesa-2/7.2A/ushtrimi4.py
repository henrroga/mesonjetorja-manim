...
class Ushtrimi4(ExerciseScene):
    ...
    def part_a(self):
        ...
        # Problem Statement
        prob_title = Text("Të dhëna:", font_size=STEP_TITLE_SIZE + 6, color=STEP_TITLE_COLOR, weight=BOLD)
        prob_line1 = MathTex(r"\text{Trekëndëshi } ABC, \quad AB = AC = 25 \text{ mm}", font_size=36)
        prob_line2 = MathTex(r"\angle B = 51^{\circ}", font_size=36)
        prob_ask = Text("Gjeni: BC = ?", font_size=34, color=STEP_TITLE_COLOR, weight=BOLD)
        ...
        s4_txt = Text("Në trekëndëshin kënddrejtë ABH:", font_size=BODY_SIZE + 2, color=BODY_TEXT_COLOR)
    ...
    def part_b(self):
        ...
        # Problem Statement
        prob_title = Text("Të dhëna:", font_size=STEP_TITLE_SIZE + 6, color=STEP_TITLE_COLOR, weight=BOLD)
        prob_line1 = MathTex(r"\text{Trekëndëshi } PQR, \quad PQ = QR = 7 \text{ cm}", font_size=36)
        prob_line2 = MathTex(r"PR = 4 \text{ cm}", font_size=36)
        prob_ask = Text("Gjeni: Të gjitha këndet", font_size=34, color=STEP_TITLE_COLOR, weight=BOLD)
        self.show_problem(prob_title, prob_line1, prob_line2, prob_ask)
        ...
        s2_txt = Text("Teorema e Pitagorës në \u25B3QPH:", font_size=BODY_SIZE, color=BODY_TEXT_COLOR)
        ...
        # Step 4: ∠R = ∠P, find ∠Q
        s4_title = self.show_step_title("Hapi 4: Këndet e tjera", reference=eqs3[-1], buff=0.5)

        s4_txt = Text("Këndet e bazës janë të barabarta:", font_size=BODY_SIZE, color=BODY_TEXT_COLOR)
        ...
        # Transition: show angles on triangle
        old_calcs2 = VGroup(s3_title, s3_txt, *eqs3, s4_title, s4_txt, *eqs4, div)
        ...
        # Final answer box
        answer_title = Text("Përgjigja:", font_size=STEP_TITLE_SIZE + 6, color=STEP_TITLE_COLOR, weight=BOLD)
