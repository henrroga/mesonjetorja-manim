"""
Reel A — Ushtrimi 9, Njësia 9.1A
Vargu: 15, 12, 9, 6, 3, ...  →  aₙ = 18 − 3n
...
class ReelA(Scene):
    ...
    def solve(self):
        ...
        terms = MathTex(
            r"15, \quad 12, \quad 9, \quad 6, \quad 3",
        ...
        # Difference arrows
        arrow_group = VGroup()
        positions = [(-1.95, 3.2), (-0.65, 3.2), (0.65, 3.2), (1.95, 3.2)]
        ...
        # a₁ = 15
        a1_eq = MathTex(r"a_1 = 15", font_size=EQ_SIZE, color=LABEL_COLOR)
