"""
Reel B — Ushtrimi 9, Njësia 9.1A
Vargu: 10, 6, 2, -2, -6, ...  →  aₙ = 14 − 4n
...
class ReelB(Scene):
    ...
    def hook(self):
        ...
        answer_tease = MathTex(r"-10", font_size=56, color=ANSWER_COLOR)
    ...
    def solve(self):
        ...
        terms = MathTex(
            r"10, \quad 6, \quad 2, \quad {-2}, \quad {-6}",
        ...
        # Difference arrows
        arrow_group = VGroup()
        positions = [(-2.05, 3.2), (-0.72, 3.2), (0.58, 3.2), (1.92, 3.2)]
        ...
        # a₁ = 10
        a1_eq = MathTex(r"a_1 = 10", font_size=EQ_SIZE, color=LABEL_COLOR)
