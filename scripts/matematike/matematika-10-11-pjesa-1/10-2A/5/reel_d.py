"""
Reel D — Ushtrimi 5, Njësia 10.2A (Pjesa 4)
Ekuacioni: x² - 7x + 3 = 0
a=1, b=-7, c=3, D=37, x₁≈6,5  x₂≈0,5
...
class ReelD(Scene):
    ...
    def solve(self):
        ...
        x_sub = MathTex(
            r"x = \frac{-(-7) \pm \sqrt{37}}{2 \cdot 1}",
            font_size=EQ_SIZE, color=WHITE,
        )
        ...
        # x1
        x1_eq = MathTex(
            r"x_1 = \frac{7 + 6{,}08}{2} = \frac{13{,}08}{2} \approx 6{,}5",
            font_size=EQ_SIZE, color=ANSWER_COLOR,
        )
        ...
        # x2
        x2_eq = MathTex(
            r"x_2 = \frac{7 - 6{,}08}{2} = \frac{0{,}92}{2} \approx 0{,}5",
            font_size=EQ_SIZE, color=ANSWER_COLOR,
        )
