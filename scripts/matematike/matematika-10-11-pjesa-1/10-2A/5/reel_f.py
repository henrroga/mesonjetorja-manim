"""
Reel F — Ushtrimi 5, Njësia 10.2A (Pjesa 6)
Ekuacioni: x² + 13x = 2  →  rirendisim: x² + 13x - 2 = 0
a=1, b=13, c=-2, D=177, x₁≈0,2  x₂≈-13,2
...
class ReelF(Scene):
    ...
    def solve(self):
        ...
        # x1
        x1_eq = MathTex(
            r"x_1 = \frac{-13 + 13{,}30}{2} = \frac{0{,}30}{2} \approx 0{,}2",
            font_size=EQ_SIZE, color=ANSWER_COLOR,
        )
        ...
        # x2
        x2_eq = MathTex(
            r"x_2 = \frac{-13 - 13{,}30}{2} = \frac{-26{,}30}{2} \approx -13{,}2",
            font_size=EQ_SIZE, color=ANSWER_COLOR,
        )
